...
<html>
    <head>
        ...
        <link href="/message/error/css/style.css" rel="stylesheet" type="text/css"/>
        ...
        <section class="aui-flexView">
            <header class="aui-navBar aui-navBar-fixed b-line">
                ...
                <div class="aui-center">
                    <span class="aui-center-title">Sorry</span>
                </div>
            ...
            <section class="aui-scrollView">
                <div class="aui-back-box">
                    <div class="aui-back-pitch">
                        <img src="/message/error/images/icon-pitch.png" alt="">
                    </div>
                    <div class="aui-back-title">
                        <h2>Full! No available space for parking.</h2>
                       <!-- <p>新密码设置成功,请牢记您的密码</p> -->
                    </div>
